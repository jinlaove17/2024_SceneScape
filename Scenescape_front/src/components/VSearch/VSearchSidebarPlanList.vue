...
<template>
  <div class="flex flex-col h-full">
    <div class="flex justify-between items-center p-3 bg-white drop-shadow-md">
      <div>
    ...
    <div class="flex-grow overflow-y-auto py-5 bg-gray-50">
      <div
        v-for="(plan, index) in planList"
        :key="plan.no"
        class="w-80 h-24 mx-auto text-sm bg-white border border-gray-200 rounded-lg drop-shadow-lg p-2 mb-5 hover:border-main-300 hover:scale-[1.02] transform duration-200 ease-in-out"
      >
        <div class="flex justify-center h-full">
          <div class="flex flex-col justify-around flex-grow overflow-hidden">
            <div>
              <p class="text-lg truncate">{{ index + 1 }}. {{ plan.title }}</p>
          ...
          <div class="flex flex-col gap-4 justify-center items-center">
            <svg
              class="w-5 h-5 fill-orange-300 cursor-pointer hover:scale-110"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
